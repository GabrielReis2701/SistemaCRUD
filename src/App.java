...
public class App {
    ...
    public static void Login(){
        ...
        do{
            ...
            senha= scanner.nextLine(); //leitura da senha
            Usuario usuario = new Usuario();
            id=usuario.Login(nome, senha); //passa o nome de usuario e a senha para serem comparados ao banco de dados ser forem compativeis volta o id do usuario ao qual estÃ¡ relacionado aos lembretes que o proprio criou
